...
import { DEVICE_HEIGHT, DEVICE_WIDTH, ICON_BLUE } from '../constants';
...
const Navbar = props => {
  ...
  const routeName = React.useMemo(() => calculateRouteName(), [props]);
  ...
  return (
    <View {...props} style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        {props.route.name !== 'Anasayfa' && (
          <StyledText style={styles.title}>{routeName}</StyledText>
        )}
      </View>
